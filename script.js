document.addEventListener('DOMContentLoaded', () => {
    ...
    { id: 'occam-razor', title: 'Occam\'s Razor', definition: 'Among competing hypotheses, the one with the fewest assumptions should be selected. The simplest explanation is usually the right one.', icon: 'cut', category: 'Decision Making', examples: ['<strong>Diagnosis:</strong> If you hear hoofbeats, think horses, not zebras. A runny nose is likely a cold, not a rare disease.', '<strong>Debugging:</strong> If a website is down, the simplest reason is a server error, not a complex cyberattack.'] },
    { id: 'inversion', title: 'Inversion', definition: 'Approaching a problem backward. Instead of aiming for success, think about what could cause failure and avoid those things.', icon: 'undo', category: 'Decision Making', examples: ['<strong>Investing:</strong> To be a great investor, first learn how to avoid losing money.', '<strong>Project Management:</strong> Ask "What could ruin this project?" and then build safeguards against those specific risks.'] },
    { id: 'first-principles', title: 'First Principles Thinking', definition: 'Breaking down a complex problem into its most basic, foundational truths and reasoning up from there.', icon: 'atom', category: 'Decision Making', examples: ['<strong>Innovation (Elon Musk):</strong> Instead of buying expensive batteries, he asked "What are batteries made of?" and sourced the raw materials for a fraction of the cost.', '<strong>Learning:</strong> Instead of memorizing formulas, understand the core concepts behind them so you can re-derive them.'] },
    { id: 'second-order-thinking', title: 'Second-Order Thinking', definition: 'Thinking beyond the immediate result of an action to consider its longer-term consequences. "And then what?"', icon: 'project-diagram', category: 'Decision Making', examples: ['<strong>Policy:</strong> Banning plastic straws (1st order: less plastic waste) might lead to more paper straws, causing deforestation (2nd order).', '<strong>Business:</strong> Cutting the R&D budget (1st order: higher profit now) can lead to a lack of innovation and future failure (2nd order).'] },
